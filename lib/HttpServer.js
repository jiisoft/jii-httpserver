...
/**
 * @class Jii.request.httpServer.HttpServer
 * @extends Jii.base.Component
 */
Jii.defineClass('Jii.request.httpServer.HttpServer', {
    ...
    _onRoute: function (expressRequest, expressResponse) {
        var request = new Jii.request.httpServer.Request(expressRequest);
        ...
        if (result !== false) {
			...
			var response = new Jii.request.httpServer.Response(expressResponse);
