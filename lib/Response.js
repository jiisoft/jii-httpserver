...
/**
 * @class Jii.request.httpServer.Response
 * @extends Jii.request.BaseResponse
 */
Jii.defineClass('Jii.request.httpServer.Response', {

	__extends: Jii.request.BaseResponse,
