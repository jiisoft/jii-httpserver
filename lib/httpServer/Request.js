 ...
 */
Jii.defineClass('Jii.httpServer.Request', {
    ...
    getHeaders: function() {
		if (this._headers === null) {
			...
			Jii._.each(this._httpMessage.headers, Jii._.bind(function(value, name) {
    ...
    getPreferredLanguage: function(languages) {
        ...
        Jii._.each(acceptedLanguages, function(acceptedLanguage) {
            acceptedLanguage = acceptedLanguage.replace('_', '-').toLowerCase();
            Jii._.each(languages, function(language) {
